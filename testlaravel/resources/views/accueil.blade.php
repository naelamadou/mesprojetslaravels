    ...
    <form id="sign_in" method="POST" action="/connexion">
        ...
        <div class="input-group">
            ...
            <div class="input is-primar">
                <input type="password" class="form-control" name="password" placeholder="veiller saisir votre email" required>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-6">
              <input class="button is-info" type="submit" name="connexion" value="s'inscrire">
            </div>                   
        </div>
    </form>
</div>
